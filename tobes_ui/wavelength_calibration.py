...
class WavelengthCalibrationGUI(CommonGUI): # pylint: disable=too-few-public-methods
    ...
    def __init__(self, root, spectrometer):
        ...
        initial_polyfit = spectrometer.read_wavelength_calibration()
        ...
        super().__init__(root, spectrometer, "Wavelength Calibration")
